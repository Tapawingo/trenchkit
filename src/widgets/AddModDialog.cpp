...
AddModDialog::AddModDialog(ModManager *modManager, QWidget *parent)
    : QDialog(parent)
...
void AddModDialog::handleZipFile(const QString &zipPath) {
...
void AddModDialog::handlePakFile(const QString &pakPath) {
